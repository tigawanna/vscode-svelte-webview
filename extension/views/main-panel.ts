...
export class MainPanel {
  ...
  public static render(context: ExtensionContext) {
    if (MainPanel.currentPanel) {
      ...
      const panel = window.createWebviewPanel('publichSelected', 'Publish Selected', ViewColumn.One, {
        enableScripts: true,
      });

      MainPanel.currentPanel = new MainPanel(panel, context);
    }
    MainPanel.currentPanel._panel.webview.postMessage({ type: 'publish', data: 'Publishing Selecetd!' });
  }
